...
page_updates:
  - page_name: <name matching (env|pattern|design|guide)-[a-z0-9-]+>
    ...
    content: |
      <full page content for create/evolve; for evolve use {{{{EVIDENCE_TABLE}}}} placeholder; NEVER use placeholder in create>
    append_evidence:
...
- For create, do NOT use {{{{EVIDENCE_TABLE}}}} — write actual evidence content.
